      ...
      <div className="container">
        <section className="slider">
          ...
          <div className="banner-horizontal">
            <img
              src="https://cdn2.cellphones.com.vn/insecure/rs:fill:1200:75/q:90/plain/https://dashboard.cellphones.com.vn/storage/ngay-hoi-dinh-gia-special-banner-desktop.gif"
